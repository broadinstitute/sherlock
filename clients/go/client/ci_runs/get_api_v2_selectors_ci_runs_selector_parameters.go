...
// NewGetAPIV2SelectorsCiRunsSelectorParams creates a new GetAPIV2SelectorsCiRunsSelectorParams object,
...
func NewGetAPIV2SelectorsCiRunsSelectorParams() *GetAPIV2SelectorsCiRunsSelectorParams {
	return &GetAPIV2SelectorsCiRunsSelectorParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPIV2SelectorsCiRunsSelectorParamsWithTimeout creates a new GetAPIV2SelectorsCiRunsSelectorParams object
...
// NewGetAPIV2SelectorsCiRunsSelectorParamsWithContext creates a new GetAPIV2SelectorsCiRunsSelectorParams object
...
// NewGetAPIV2SelectorsCiRunsSelectorParamsWithHTTPClient creates a new GetAPIV2SelectorsCiRunsSelectorParams object
...
/* GetAPIV2SelectorsCiRunsSelectorParams contains all the parameters to send to the API endpoint
   for the get API v2 selectors ci runs selector operation.

   Typically these are written to a http.Request.
*/
type GetAPIV2SelectorsCiRunsSelectorParams struct {

	/* Selector.

	   The selector of the CiRun to list other selectors for
	*/
	Selector string
