...
func (m *V2controllersAppVersion) validateCiIdentifier(formats strfmt.Registry) error {
...
func (m *V2controllersAppVersion) contextValidateCiIdentifier(ctx context.Context, formats strfmt.Registry) error {
