...
export const AppVersionsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {V2controllersCreatableAppVersion} appVersion The AppVersion to create
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2AppVersionsPost(appVersion: V2controllersCreatableAppVersion, options: any = {}): FetchArgs {
            // verify required parameter 'appVersion' is not null or undefined
            if (appVersion === null || appVersion === undefined) {
                throw new RequiredError('appVersion','Required parameter appVersion was null or undefined when calling apiV2AppVersionsPost.');
            }
            const localVarPath = `/api/v2/app-versions`;
            const localVarUrlObj = url.parse(localVarPath, true);
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(appVersion || {}) : (appVersion || "");
...
export const AppVersionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2AppVersionsPost(appVersion: V2controllersCreatableAppVersion, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersAppVersion> {
            const localVarFetchArgs = AppVersionsApiFetchParamCreator(configuration).apiV2AppVersionsPost(appVersion, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const AppVersionsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2AppVersionsPost(appVersion: V2controllersCreatableAppVersion, options?: any) {
            return AppVersionsApiFp(configuration).apiV2AppVersionsPost(appVersion, options)(fetch, basePath);
        },
        /**
         * Get an existing AppVersion entry via one its \"selector\"--its numeric ID.
         * @summary Get a AppVersion entry
...
export class AppVersionsApi extends BaseAPI {
     ...
     * @memberof AppVersionsApi
     */
    public apiV2AppVersionsPost(appVersion: V2controllersCreatableAppVersion, options?: any) {
        return AppVersionsApiFp(this.configuration).apiV2AppVersionsPost(appVersion, options)(this.fetch, this.basePath);
    }
...
export const ChartDeployRecordsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {V2controllersCreatableChartDeployRecord} chartDeployRecord The ChartDeployRecord to create
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2ChartDeployRecordsPost(chartDeployRecord: V2controllersCreatableChartDeployRecord, options: any = {}): FetchArgs {
            // verify required parameter 'chartDeployRecord' is not null or undefined
            if (chartDeployRecord === null || chartDeployRecord === undefined) {
                throw new RequiredError('chartDeployRecord','Required parameter chartDeployRecord was null or undefined when calling apiV2ChartDeployRecordsPost.');
            }
            const localVarPath = `/api/v2/chart-deploy-records`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(chartDeployRecord || {}) : (chartDeployRecord || "");
...
export const ChartDeployRecordsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartDeployRecordsPost(chartDeployRecord: V2controllersCreatableChartDeployRecord, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersChartDeployRecord> {
            const localVarFetchArgs = ChartDeployRecordsApiFetchParamCreator(configuration).apiV2ChartDeployRecordsPost(chartDeployRecord, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ChartDeployRecordsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartDeployRecordsPost(chartDeployRecord: V2controllersCreatableChartDeployRecord, options?: any) {
            return ChartDeployRecordsApiFp(configuration).apiV2ChartDeployRecordsPost(chartDeployRecord, options)(fetch, basePath);
        },
        /**
         * Get an existing ChartDeployRecord entry via one its \"selector\"--its numeric ID.
         * @summary Get a ChartDeployRecord entry
...
export class ChartDeployRecordsApi extends BaseAPI {
     ...
     * @memberof ChartDeployRecordsApi
     */
    public apiV2ChartDeployRecordsPost(chartDeployRecord: V2controllersCreatableChartDeployRecord, options?: any) {
        return ChartDeployRecordsApiFp(this.configuration).apiV2ChartDeployRecordsPost(chartDeployRecord, options)(this.fetch, this.basePath);
    }
...
export const ChartReleasesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'branch' | 'commit' | 'exact'} [targetAppVersionUse] When creating, will default to referencing any provided target app version field (exact, then commit, then branch)
         * @param {string} [targetChartVersionExact] 
         * @param {'latest' | 'exact'} [targetChartVersionUse] When creating, will default to latest unless an exact target chart version is provided
         ...
         * @param {V2controllersCreatableChartRelease} chartRelease The ChartRelease to create
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2ChartReleasesPost(chartRelease: V2controllersCreatableChartRelease, options: any = {}): FetchArgs {
            // verify required parameter 'chartRelease' is not null or undefined
            if (chartRelease === null || chartRelease === undefined) {
                throw new RequiredError('chartRelease','Required parameter chartRelease was null or undefined when calling apiV2ChartReleasesPost.');
            }
            const localVarPath = `/api/v2/chart-releases`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(chartRelease || {}) : (chartRelease || "");
         ...
         * @param {V2controllersEditableChartRelease} chartRelease The edits to make to the ChartRelease
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2ChartReleasesSelectorPatch(selector: string, chartRelease: V2controllersEditableChartRelease, options: any = {}): FetchArgs {
            // verify required parameter 'selector' is not null or undefined
            if (selector === null || selector === undefined) {
            ...
            // verify required parameter 'chartRelease' is not null or undefined
            if (chartRelease === null || chartRelease === undefined) {
                throw new RequiredError('chartRelease','Required parameter chartRelease was null or undefined when calling apiV2ChartReleasesSelectorPatch.');
            }
            const localVarPath = `/api/v2/chart-releases/{selector}`
                .replace(`{${"selector"}}`, encodeURIComponent(String(selector)));
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const ChartReleasesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartReleasesGet(chart?: string, cluster?: string, createdAt?: string, currentAppVersionExact?: string, currentChartVersionExact?: string, destinationType?: string, environment?: string, helmfileRef?: string, id?: number, name?: string, namespace?: string, targetAppVersionBranch?: string, targetAppVersionCommit?: string, targetAppVersionExact?: string, targetAppVersionUse?: 'branch' | 'commit' | 'exact', targetChartVersionExact?: string, targetChartVersionUse?: 'latest' | 'exact', thelmaMode?: string, updatedAt?: string, limit?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<V2controllersChartRelease>> {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartReleasesPost(chartRelease: V2controllersCreatableChartRelease, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersChartRelease> {
            const localVarFetchArgs = ChartReleasesApiFetchParamCreator(configuration).apiV2ChartReleasesPost(chartRelease, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiV2ChartReleasesSelectorPatch(selector: string, chartRelease: V2controllersEditableChartRelease, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersChartRelease> {
            const localVarFetchArgs = ChartReleasesApiFetchParamCreator(configuration).apiV2ChartReleasesSelectorPatch(selector, chartRelease, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ChartReleasesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartReleasesGet(chart?: string, cluster?: string, createdAt?: string, currentAppVersionExact?: string, currentChartVersionExact?: string, destinationType?: string, environment?: string, helmfileRef?: string, id?: number, name?: string, namespace?: string, targetAppVersionBranch?: string, targetAppVersionCommit?: string, targetAppVersionExact?: string, targetAppVersionUse?: 'branch' | 'commit' | 'exact', targetChartVersionExact?: string, targetChartVersionUse?: 'latest' | 'exact', thelmaMode?: string, updatedAt?: string, limit?: number, options?: any) {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartReleasesPost(chartRelease: V2controllersCreatableChartRelease, options?: any) {
            return ChartReleasesApiFp(configuration).apiV2ChartReleasesPost(chartRelease, options)(fetch, basePath);
        },
        /**
         * Delete an existing ChartRelease entry via one of its \"selectors\": name, numeric ID, environment/chart, or cluster/namespace/chart.
         * @summary Delete a ChartRelease entry
         ...
         * @throws {RequiredError}
         */
        apiV2ChartReleasesSelectorPatch(selector: string, chartRelease: V2controllersEditableChartRelease, options?: any) {
            return ChartReleasesApiFp(configuration).apiV2ChartReleasesSelectorPatch(selector, chartRelease, options)(fetch, basePath);
        },
        /**
         * Validate a given ChartRelease selector and provide any other selectors that would match the same ChartRelease.
         * @summary List ChartRelease selectors
...
export class ChartReleasesApi extends BaseAPI {
     ...
     * @memberof ChartReleasesApi
     */
    public apiV2ChartReleasesPost(chartRelease: V2controllersCreatableChartRelease, options?: any) {
        return ChartReleasesApiFp(this.configuration).apiV2ChartReleasesPost(chartRelease, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ChartReleasesApi
     */
    public apiV2ChartReleasesSelectorPatch(selector: string, chartRelease: V2controllersEditableChartRelease, options?: any) {
        return ChartReleasesApiFp(this.configuration).apiV2ChartReleasesSelectorPatch(selector, chartRelease, options)(this.fetch, this.basePath);
    }
...
export const ChartVersionsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {V2controllersCreatableChartVersion} chartVersion The ChartVersion to create
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2ChartVersionsPost(chartVersion: V2controllersCreatableChartVersion, options: any = {}): FetchArgs {
            // verify required parameter 'chartVersion' is not null or undefined
            if (chartVersion === null || chartVersion === undefined) {
                throw new RequiredError('chartVersion','Required parameter chartVersion was null or undefined when calling apiV2ChartVersionsPost.');
            }
            const localVarPath = `/api/v2/chart-versions`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(chartVersion || {}) : (chartVersion || "");
...
export const ChartVersionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartVersionsPost(chartVersion: V2controllersCreatableChartVersion, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersChartVersion> {
            const localVarFetchArgs = ChartVersionsApiFetchParamCreator(configuration).apiV2ChartVersionsPost(chartVersion, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ChartVersionsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartVersionsPost(chartVersion: V2controllersCreatableChartVersion, options?: any) {
            return ChartVersionsApiFp(configuration).apiV2ChartVersionsPost(chartVersion, options)(fetch, basePath);
        },
        /**
         * Get an existing ChartVersion entry via one its \"selector\"--its numeric ID.
         * @summary Get a ChartVersion entry
...
export class ChartVersionsApi extends BaseAPI {
     ...
     * @memberof ChartVersionsApi
     */
    public apiV2ChartVersionsPost(chartVersion: V2controllersCreatableChartVersion, options?: any) {
        return ChartVersionsApiFp(this.configuration).apiV2ChartVersionsPost(chartVersion, options)(this.fetch, this.basePath);
    }
...
export const ChartsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {V2controllersCreatableChart} chart The Chart to create
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2ChartsPost(chart: V2controllersCreatableChart, options: any = {}): FetchArgs {
            // verify required parameter 'chart' is not null or undefined
            if (chart === null || chart === undefined) {
                throw new RequiredError('chart','Required parameter chart was null or undefined when calling apiV2ChartsPost.');
            }
            const localVarPath = `/api/v2/charts`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(chart || {}) : (chart || "");
         ...
         * @param {V2controllersEditableChart} chart The edits to make to the Chart
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2ChartsSelectorPatch(selector: string, chart: V2controllersEditableChart, options: any = {}): FetchArgs {
            // verify required parameter 'selector' is not null or undefined
            if (selector === null || selector === undefined) {
            ...
            // verify required parameter 'chart' is not null or undefined
            if (chart === null || chart === undefined) {
                throw new RequiredError('chart','Required parameter chart was null or undefined when calling apiV2ChartsSelectorPatch.');
            }
            const localVarPath = `/api/v2/charts/{selector}`
                .replace(`{${"selector"}}`, encodeURIComponent(String(selector)));
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const ChartsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartsPost(chart: V2controllersCreatableChart, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersChart> {
            const localVarFetchArgs = ChartsApiFetchParamCreator(configuration).apiV2ChartsPost(chart, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiV2ChartsSelectorPatch(selector: string, chart: V2controllersEditableChart, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersChart> {
            const localVarFetchArgs = ChartsApiFetchParamCreator(configuration).apiV2ChartsSelectorPatch(selector, chart, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ChartsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ChartsPost(chart: V2controllersCreatableChart, options?: any) {
            return ChartsApiFp(configuration).apiV2ChartsPost(chart, options)(fetch, basePath);
        },
        /**
         * Delete an existing Chart entry via one of its \"selectors\": name or numeric ID.
         * @summary Delete a Chart entry
         ...
         * @throws {RequiredError}
         */
        apiV2ChartsSelectorPatch(selector: string, chart: V2controllersEditableChart, options?: any) {
            return ChartsApiFp(configuration).apiV2ChartsSelectorPatch(selector, chart, options)(fetch, basePath);
        },
        /**
         * Validate a given Chart selector and provide any other selectors that would match the same Chart.
         * @summary List Chart selectors
...
export class ChartsApi extends BaseAPI {
     ...
     * @memberof ChartsApi
     */
    public apiV2ChartsPost(chart: V2controllersCreatableChart, options?: any) {
        return ChartsApiFp(this.configuration).apiV2ChartsPost(chart, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ChartsApi
     */
    public apiV2ChartsSelectorPatch(selector: string, chart: V2controllersEditableChart, options?: any) {
        return ChartsApiFp(this.configuration).apiV2ChartsSelectorPatch(selector, chart, options)(this.fetch, this.basePath);
    }
...
export const ClustersApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ClustersGet(name: string, address?: string, azureSubscription?: string, base?: string, createdAt?: string, googleProject?: string, id?: number, provider?: 'google' | 'azure', requiresSuitability?: boolean, updatedAt?: string, limit?: number, options: any = {}): FetchArgs {
         ...
         * @param {V2controllersCreatableCluster} cluster The Cluster to create
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2ClustersPost(cluster: V2controllersCreatableCluster, options: any = {}): FetchArgs {
            // verify required parameter 'cluster' is not null or undefined
            if (cluster === null || cluster === undefined) {
                throw new RequiredError('cluster','Required parameter cluster was null or undefined when calling apiV2ClustersPost.');
            }
            const localVarPath = `/api/v2/clusters`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
         ...
         * @param {V2controllersEditableCluster} cluster The edits to make to the Cluster
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2ClustersSelectorPatch(selector: string, cluster: V2controllersEditableCluster, options: any = {}): FetchArgs {
            // verify required parameter 'selector' is not null or undefined
            if (selector === null || selector === undefined) {
            ...
            // verify required parameter 'cluster' is not null or undefined
            if (cluster === null || cluster === undefined) {
                throw new RequiredError('cluster','Required parameter cluster was null or undefined when calling apiV2ClustersSelectorPatch.');
            }
            const localVarPath = `/api/v2/clusters/{selector}`
                .replace(`{${"selector"}}`, encodeURIComponent(String(selector)));
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const ClustersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ClustersGet(name: string, address?: string, azureSubscription?: string, base?: string, createdAt?: string, googleProject?: string, id?: number, provider?: 'google' | 'azure', requiresSuitability?: boolean, updatedAt?: string, limit?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<V2controllersCluster>> {
         ...
         * @throws {RequiredError}
         */
        apiV2ClustersPost(cluster: V2controllersCreatableCluster, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersCluster> {
            const localVarFetchArgs = ClustersApiFetchParamCreator(configuration).apiV2ClustersPost(cluster, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiV2ClustersSelectorPatch(selector: string, cluster: V2controllersEditableCluster, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersCluster> {
            const localVarFetchArgs = ClustersApiFetchParamCreator(configuration).apiV2ClustersSelectorPatch(selector, cluster, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ClustersApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2ClustersGet(name: string, address?: string, azureSubscription?: string, base?: string, createdAt?: string, googleProject?: string, id?: number, provider?: 'google' | 'azure', requiresSuitability?: boolean, updatedAt?: string, limit?: number, options?: any) {
         ...
         * @throws {RequiredError}
         */
        apiV2ClustersPost(cluster: V2controllersCreatableCluster, options?: any) {
            return ClustersApiFp(configuration).apiV2ClustersPost(cluster, options)(fetch, basePath);
        },
        /**
         * Delete an existing Cluster entry via one of its \"selectors\": name or numeric ID.
         * @summary Delete a Cluster entry
         ...
         * @throws {RequiredError}
         */
        apiV2ClustersSelectorPatch(selector: string, cluster: V2controllersEditableCluster, options?: any) {
            return ClustersApiFp(configuration).apiV2ClustersSelectorPatch(selector, cluster, options)(fetch, basePath);
        },
        /**
         * Validate a given Cluster selector and provide any other selectors that would match the same Cluster.
         * @summary List Cluster selectors
...
export class ClustersApi extends BaseAPI {
     ...
     */
    public apiV2ClustersGet(name: string, address?: string, azureSubscription?: string, base?: string, createdAt?: string, googleProject?: string, id?: number, provider?: 'google' | 'azure', requiresSuitability?: boolean, updatedAt?: string, limit?: number, options?: any) {
     ...
     * @memberof ClustersApi
     */
    public apiV2ClustersPost(cluster: V2controllersCreatableCluster, options?: any) {
        return ClustersApiFp(this.configuration).apiV2ClustersPost(cluster, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ClustersApi
     */
    public apiV2ClustersSelectorPatch(selector: string, cluster: V2controllersEditableCluster, options?: any) {
        return ClustersApiFp(this.configuration).apiV2ClustersSelectorPatch(selector, cluster, options)(this.fetch, this.basePath);
    }
...
export const EnvironmentsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {V2controllersCreatableEnvironment} environment The Environment to create
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2EnvironmentsPost(environment: V2controllersCreatableEnvironment, options: any = {}): FetchArgs {
            // verify required parameter 'environment' is not null or undefined
            if (environment === null || environment === undefined) {
                throw new RequiredError('environment','Required parameter environment was null or undefined when calling apiV2EnvironmentsPost.');
            }
            const localVarPath = `/api/v2/environments`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
         ...
         * @param {V2controllersEditableEnvironment} environment The edits to make to the Environment
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiV2EnvironmentsSelectorPatch(selector: string, environment: V2controllersEditableEnvironment, options: any = {}): FetchArgs {
            // verify required parameter 'selector' is not null or undefined
            if (selector === null || selector === undefined) {
            ...
            // verify required parameter 'environment' is not null or undefined
            if (environment === null || environment === undefined) {
                throw new RequiredError('environment','Required parameter environment was null or undefined when calling apiV2EnvironmentsSelectorPatch.');
            }
            const localVarPath = `/api/v2/environments/{selector}`
                .replace(`{${"selector"}}`, encodeURIComponent(String(selector)));
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const EnvironmentsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2EnvironmentsPost(environment: V2controllersCreatableEnvironment, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersEnvironment> {
            const localVarFetchArgs = EnvironmentsApiFetchParamCreator(configuration).apiV2EnvironmentsPost(environment, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiV2EnvironmentsSelectorPatch(selector: string, environment: V2controllersEditableEnvironment, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2controllersEnvironment> {
            const localVarFetchArgs = EnvironmentsApiFetchParamCreator(configuration).apiV2EnvironmentsSelectorPatch(selector, environment, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const EnvironmentsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2EnvironmentsPost(environment: V2controllersCreatableEnvironment, options?: any) {
            return EnvironmentsApiFp(configuration).apiV2EnvironmentsPost(environment, options)(fetch, basePath);
        },
        /**
         * Delete an existing Environment entry via one of its \"selectors\": name or numeric ID.
         * @summary Delete a Environment entry
         ...
         * @throws {RequiredError}
         */
        apiV2EnvironmentsSelectorPatch(selector: string, environment: V2controllersEditableEnvironment, options?: any) {
            return EnvironmentsApiFp(configuration).apiV2EnvironmentsSelectorPatch(selector, environment, options)(fetch, basePath);
        },
        /**
         * Validate a given Environment selector and provide any other selectors that would match the same Environment.
         * @summary List Environment selectors
...
export class EnvironmentsApi extends BaseAPI {
     ...
     * @memberof EnvironmentsApi
     */
    public apiV2EnvironmentsPost(environment: V2controllersCreatableEnvironment, options?: any) {
        return EnvironmentsApiFp(this.configuration).apiV2EnvironmentsPost(environment, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof EnvironmentsApi
     */
    public apiV2EnvironmentsSelectorPatch(selector: string, environment: V2controllersEditableEnvironment, options?: any) {
        return EnvironmentsApiFp(this.configuration).apiV2EnvironmentsSelectorPatch(selector, environment, options)(this.fetch, this.basePath);
    }
