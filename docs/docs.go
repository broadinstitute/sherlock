        ...
        "/api/v2/database-instances/{selector}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The DatabaseInstance to get's selector: numeric ID of 'chart-release/' followed by a chart release selector",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The DatabaseInstance to upsert's selector: numeric ID of 'chart-release/' followed by a chart release selector",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    },
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The DatabaseInstance to delete's selector: numeric ID of 'chart-release/' followed by a chart release selector",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The DatabaseInstance to edit's selector: numeric ID of 'chart-release/' followed by a chart release selector",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    },
