    ...
    add constraint app_version_resolver_valid
        check ((app_version_resolver is not null or app_version_resolver != '') and
               ...
               (app_version_resolver = 'none' and
                (app_version_branch is null and app_version_branch = '') and
                (app_version_commit is null and app_version_commit = '') and
                (app_version_exact is null and app_version_exact = '') and
