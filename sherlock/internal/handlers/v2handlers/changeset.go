...
func listChangeset(controller *v2controllers.ChangesetController) func(ctx *gin.Context) {
...
func getChangeset(controller *v2controllers.ChangesetController) func(ctx *gin.Context) {
...
func listChangesetSelectors(controller *v2controllers.ChangesetController) func(ctx *gin.Context) {
...
func planAndApplyChangeset(controller *v2controllers.ChangesetController) func(ctx *gin.Context) {
	return func(ctx *gin.Context) {
		...
		var request v2controllers.ChangesetPlanRequest
