...
func listUser(controller *v2controllers2.UserController) func(ctx *gin.Context) {
...
func getUser(controller *v2controllers2.UserController) func(ctx *gin.Context) {
...
func editUser(controller *v2controllers2.UserController) func(ctx *gin.Context) {
...
func listUserSelectors(controller *v2controllers2.UserController) func(ctx *gin.Context) {
