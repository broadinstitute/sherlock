...
We already had code that helped manage Firecloud accounts but it was in Jenkins, and there were a few significant problems with that (mainly security and reliability). Around the time that those issues began to boil over, Sherlock gained both production-approval and access to the BITS data warehouse, opening it up as another potential location for this code.
