...
//
//  2. Endpoints selecting an individual entry (e.g. editing, deletion) should consume the entirety of the rest of the
...
//
//  3. Non-CRUD endpoints should be offered at `<type>/procedures/<version>/<behavior>`.
//
//     - This differentiates CRUD and non-CRUD endpoints.
//
//  4. The endpoints should categorize themselves by their type on the Swagger page.
//
//     - This should be done with the @tags directive in the route documentation, see
//     https://github.com/swaggo/swag#api-operation.
//
//  5. If endpoints based on different types are uniquely similar or associated to each other, they may prefix their
