...
func (s *handlerSuite) TestGithubActionsDeployHooksV3List() {
	...
	hook1 := models.GithubActionsDeployHook{
		...
		GithubActionsWorkflowPath: testutils.PointerTo("path-1"),
	...
	hook2 := models.GithubActionsDeployHook{
		...
		GithubActionsOwner:        testutils.PointerTo("owner"),
		GithubActionsRepo:         testutils.PointerTo("repo"),
		GithubActionsWorkflowPath: testutils.PointerTo("path-2"),
		GithubActionsDefaultRef:   testutils.PointerTo("head"),
		GithubActionsRefBehavior:  testutils.PointerTo("always-use-default-ref"),
	}
	hook3 := models.GithubActionsDeployHook{
		...
		GithubActionsOwner:        testutils.PointerTo("owner"),
		GithubActionsRepo:         testutils.PointerTo("repo"),
		GithubActionsWorkflowPath: testutils.PointerTo("path-3"),
		GithubActionsDefaultRef:   testutils.PointerTo("head"),
		GithubActionsRefBehavior:  testutils.PointerTo("always-use-default-ref"),
	}
