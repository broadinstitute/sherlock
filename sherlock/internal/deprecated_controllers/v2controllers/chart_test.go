...
func (suite *chartControllerSuite) SetupSuite() {
...
func (suite *chartControllerSuite) TearDownSuite() {
...
func (suite *chartControllerSuite) TestChartEdit() {
	suite.Run("successfully", func() {
		...
		assert.Equal(suite.T(), newPactParticipant, edited.PactParticipant)
		...
		assert.Equal(suite.T(), newPactParticipant, after.PactParticipant)
	})
