...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/service-alerts/v3": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Control how many Service Alerts are returned (default 0, no limit)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The initial fields the ServiceAlert should have set",
                        "name": "serviceAlert",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sherlock.ServiceAlertV3Create"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/service-alerts/v3/{selector}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The selector of the ServiceAlert, which is the guid for a given alert",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The selector of the ServiceAlert, ServiceAlert, which is the guid for a given alert",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "The edits to make to the ServiceAlert",
                        "name": "service-alert",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sherlock.ServiceAlertV3EditableFields"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "sherlock.ServiceAlertV3EditableFields": {
            "type": "object",
            "properties": {
                "link": {
                    "type": "string"
