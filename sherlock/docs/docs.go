...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v2/ci-identifiers/{selector}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The CiIdentifier to get's selector: ID or type + '/' + selector of the referenced type",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The CiIdentifier to upsert's selector: ID or type + '/' + selector of the referenced type",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    },
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The CiIdentifier to edit's selector: ID or type + '/' + selector of the referenced type",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/v2/ci-runs/{selector}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The CiRun to get's selector: ID, 'github-actions/' + owner + repo + run ID + attempt number, or 'argo-workflows/' + namespace + name",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The CiRun to upsert's selector: ID, 'github-actions/' + owner + repo + run ID + attempt number, or 'argo-workflows/' + namespace + name",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    },
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The CiRun to delete's selector: ID, 'github-actions/' + owner + repo + run ID + attempt number, or 'argo-workflows/' + namespace + name",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The CiRun to edit's selector: ID, 'github-actions/' + owner + repo + run ID + attempt number, or 'argo-workflows/' + namespace + name",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/v2/database-instances/{selector}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The DatabaseInstance to get's selector: numeric ID or 'chart-release/' followed by a chart release selector",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The DatabaseInstance to upsert's selector: numeric ID or 'chart-release/' followed by a chart release selector",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    },
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The DatabaseInstance to delete's selector: numeric ID or 'chart-release/' followed by a chart release selector",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The DatabaseInstance to edit's selector: numeric ID or 'chart-release/' followed by a chart release selector",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/v2/procedures/changesets/query-applied-for-version/{version-type}/{chart}/{version}": {
            "get": {
                "description": "List existing applied Changesets that newly deployed a given App Version or Chart Version, ordered by most recently applied.",
                "produces": [
                    "application/json"
        ...
        "/api/v2/selectors/database-instances/{selector}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The selector of the DatabaseInstance to list other selectors for",
                        "name": "selector",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "v2controllers.CreatableCiRun": {
            ...
            "properties": {
                ...
                "changesets": {
                    "description": "Always appends; will eliminate duplicates. Spreads to associated chart releases (and environments and clusters) and new app/chart versions.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
