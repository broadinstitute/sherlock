...
class TestSherlockCiIdentifierV3(unittest.TestCase):
    """SherlockCiIdentifierV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SherlockCiIdentifierV3:
        """Test SherlockCiIdentifierV3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SherlockCiIdentifierV3`
        """
        model = SherlockCiIdentifierV3()
        if include_optional:
            return SherlockCiIdentifierV3(
                ci_runs = [
    ...
    def testSherlockCiIdentifierV3(self):
        """Test SherlockCiIdentifierV3"""
