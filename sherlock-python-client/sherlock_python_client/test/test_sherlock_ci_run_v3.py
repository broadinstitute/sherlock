...
class TestSherlockCiRunV3(unittest.TestCase):
    """SherlockCiRunV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SherlockCiRunV3:
        """Test SherlockCiRunV3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SherlockCiRunV3`
        """
        model = SherlockCiRunV3()
        if include_optional:
            return SherlockCiRunV3(
                argo_workflows_name = '',
