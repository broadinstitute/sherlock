...
class SherlockGithubActionsJobV3(BaseModel):
    """
    ...
    github_actions_job_id: Optional[StrictInt] = Field(default=None, alias="githubActionsJobID")
    ...
    job_created_at: Optional[datetime] = Field(default=None, alias="jobCreatedAt")
    job_started_at: Optional[datetime] = Field(default=None, alias="jobStartedAt")
    job_terminal_at: Optional[datetime] = Field(default=None, alias="jobTerminalAt")
    status: Optional[StrictStr] = None
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["createdAt", "githubActionsAttemptNumber", "githubActionsJobID", "githubActionsOwner", "githubActionsRepo", "githubActionsRunID", "id", "jobCreatedAt", "jobStartedAt", "jobTerminalAt", "status", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "githubActionsJobID": obj.get("githubActionsJobID"),
            ...
            "id": obj.get("id"),
            "jobCreatedAt": obj.get("jobCreatedAt"),
            "jobStartedAt": obj.get("jobStartedAt"),
            "jobTerminalAt": obj.get("jobTerminalAt"),
