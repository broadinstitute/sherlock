...
class SherlockGithubActionsDeployHookTestRunRequest(BaseModel):
    """
    SherlockGithubActionsDeployHookTestRunRequest
    """ # noqa: E501
    execute: Optional[StrictBool] = Field(default=None, description="Required, whether to fully run the GHA")
