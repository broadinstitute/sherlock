...
class SherlockServiceAlertV3Create(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["link", "message", "onEnvironment", "severity", "title"]
    ...
    def severity_validate_enum(cls, value):
        ...
        if value not in set(['blocker', ' critical', ' minor']):
            raise ValueError("must be one of enum values ('blocker', ' critical', ' minor')")
        return value
