...
class SherlockSlackDeployHookTestRunRequest(BaseModel):
    """
    SherlockSlackDeployHookTestRunRequest
    """ # noqa: E501
    execute: Optional[StrictBool] = Field(default=None, description="Required, whether to actually send the Slack message")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["execute"]
