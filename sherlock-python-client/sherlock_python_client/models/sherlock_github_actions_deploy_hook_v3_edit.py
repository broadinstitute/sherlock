...
class SherlockGithubActionsDeployHookV3Edit(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["githubActionsDefaultRef", "githubActionsOwner", "githubActionsRefBehavior", "githubActionsRepo", "githubActionsWorkflowInputs", "githubActionsWorkflowPath", "onFailure", "onSuccess"]
