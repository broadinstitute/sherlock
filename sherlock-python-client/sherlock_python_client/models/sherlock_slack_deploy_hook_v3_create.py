...
class SherlockSlackDeployHookV3Create(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mentionPeople", "onChartRelease", "onEnvironment", "onFailure", "onSuccess", "slackChannel"]
