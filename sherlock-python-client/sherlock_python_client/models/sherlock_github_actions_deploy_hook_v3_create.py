...
class SherlockGithubActionsDeployHookV3Create(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["githubActionsDefaultRef", "githubActionsOwner", "githubActionsRefBehavior", "githubActionsRepo", "githubActionsWorkflowInputs", "githubActionsWorkflowPath", "onChartRelease", "onEnvironment", "onFailure", "onSuccess"]
