...
class SherlockGithubActionsJobV3Create(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["githubActionsAttemptNumber", "githubActionsJobID", "githubActionsOwner", "githubActionsRepo", "githubActionsRunID", "jobCreatedAt", "jobStartedAt", "jobTerminalAt", "status"]
