...
class SherlockSlackDeployHookV3(BaseModel):
    """
    SherlockSlackDeployHookV3
    """ # noqa: E501
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    id: Optional[StrictInt] = None
    mention_people: Optional[StrictBool] = Field(default=None, alias="mentionPeople")
    ...
    slack_channel: Optional[StrictStr] = Field(default=None, alias="slackChannel")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["createdAt", "id", "mentionPeople", "onChartRelease", "onEnvironment", "onFailure", "onSuccess", "slackChannel", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "mentionPeople": obj.get("mentionPeople"),
