...
class ServiceAlertApi:
    ...
    @validate_call
    def api_service_alerts_procedures_v3_sync_post(
        self,
        environment: Annotated[SherlockServiceAlertV3SyncRequest, Field(description="Information on Service Alert environment")],
        ...
        :param environment: Information on Service Alert environment (required)
        :type environment: SherlockServiceAlertV3SyncRequest
        ...
        _param = self._api_service_alerts_procedures_v3_sync_post_serialize(
    ...
    @validate_call
    def api_service_alerts_procedures_v3_sync_post_with_http_info(
        self,
        environment: Annotated[SherlockServiceAlertV3SyncRequest, Field(description="Information on Service Alert environment")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_service_alerts_procedures_v3_sync_post_without_preload_content(
        self,
        environment: Annotated[SherlockServiceAlertV3SyncRequest, Field(description="Information on Service Alert environment")],
        _request_timeout: Union[
            None,
    ...
    def _api_service_alerts_procedures_v3_sync_post_serialize(
        self,
        environment,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/service-alerts/procedures/v3/sync',
