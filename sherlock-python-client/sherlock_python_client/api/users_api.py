...
class UsersApi:
    ...
    @validate_call
    def api_users_procedures_v3_deactivate_post(
        self,
        users: Annotated[SherlockUserV3DeactivateRequest, Field(description="Information on the users to deactivate")],
        ...
        :param users: Information on the users to deactivate (required)
        :type users: SherlockUserV3DeactivateRequest
        ...
        _param = self._api_users_procedures_v3_deactivate_post_serialize(
            users=users,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SherlockUserV3DeactivateResponse",
    ...
    @validate_call
    def api_users_procedures_v3_deactivate_post_with_http_info(
        self,
        users: Annotated[SherlockUserV3DeactivateRequest, Field(description="Information on the users to deactivate")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SherlockUserV3DeactivateResponse]:
        """Deactivate Users
    ...
    @validate_call
    def api_users_procedures_v3_deactivate_post_without_preload_content(
        self,
        users: Annotated[SherlockUserV3DeactivateRequest, Field(description="Information on the users to deactivate")],
        _request_timeout: Union[
            None,
    ...
    def _api_users_procedures_v3_deactivate_post_serialize(
        self,
        users,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/users/procedures/v3/deactivate',
