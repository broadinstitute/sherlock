...
class GitCommitsApi:
    ...
    @validate_call
    def api_git_commits_v3_put(
        self,
        git_commit: Annotated[SherlockGitCommitV3Upsert, Field(description="The GitCommit to upsert")],
        ...
        :param git_commit: The GitCommit to upsert (required)
        :type git_commit: SherlockGitCommitV3Upsert
        ...
        _param = self._api_git_commits_v3_put_serialize(
    ...
    @validate_call
    def api_git_commits_v3_put_with_http_info(
        self,
        git_commit: Annotated[SherlockGitCommitV3Upsert, Field(description="The GitCommit to upsert")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SherlockGitCommitV3]:
        """Upsert a GitCommit
    ...
    @validate_call
    def api_git_commits_v3_put_without_preload_content(
        self,
        git_commit: Annotated[SherlockGitCommitV3Upsert, Field(description="The GitCommit to upsert")],
        _request_timeout: Union[
            None,
    ...
    def _api_git_commits_v3_put_serialize(
        self,
        git_commit,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/git-commits/v3',
