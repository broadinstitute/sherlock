...
```typescript
import type { SherlockGithubActionsDeployHookV3Create } from '@sherlock-js-client/sherlock'
...
const example = {
  ...
  "onFailure": null,
  "onSuccess": null,
} satisfies SherlockGithubActionsDeployHookV3Create
...
const exampleParsed = JSON.parse(exampleJSON) as SherlockGithubActionsDeployHookV3Create
