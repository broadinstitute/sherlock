...
type ServiceInstanceIntegrationTestSuite struct {
	suite.Suite
	app                *testApplication
	goodEnvironmentReq v1_models2.CreateEnvironmentRequest
	goodServiceReq     v1_models2.CreateServiceRequest
	goodClusterReq     v1_models2.CreateClusterRequest
}
...
func (suite *ServiceInstanceIntegrationTestSuite) SetupTest() {
	...
	suite.goodEnvironmentReq = v1_models2.CreateEnvironmentRequest{
		Name: faker.UUIDHyphenated(),
	}

	suite.goodServiceReq = v1_models2.CreateServiceRequest{
		Name:    faker.UUIDHyphenated(),
		RepoURL: faker.URL(),
	}

	suite.goodClusterReq = v1_models2.CreateClusterRequest{
		Name: faker.Word(),
	}
}
...
func (suite *ServiceInstanceIntegrationTestSuite) TestListServiceInstancesError() {
	...
	controller := setupMockController(suite.T(), []v1_models2.ServiceInstance{}, targetError, "ListAll")
...
func (suite *ServiceInstanceIntegrationTestSuite) TestGetByEnvironmentAndServiceName() {
	...
	suite.Run("it returns error not found for non-existent record", func() {
		...
		suite.Assert().ErrorIs(err, v1_models2.ErrServiceInstanceNotFound)
	})
...
func setupMockController(
	t *testing.T,
	expectedServiceInstances []v1_models2.ServiceInstance,
...
func (suite *ServiceInstanceIntegrationTestSuite) preProvisionDependentObjects(makeCluster, makeService, makeEnv bool) (v1_models2.Cluster, v1_models2.Service, v1_models2.Environment) {
	var preExistingEnv v1_models2.Environment
	var preExistingService v1_models2.Service
	var preExistingCluster v1_models2.Cluster
	var err error
