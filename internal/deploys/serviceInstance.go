...
type ServiceInstanceController struct {
	store        v1_models.ServiceInstanceStore
...
func NewServiceInstanceController(dbConn *gorm.DB) *ServiceInstanceController {
	store := v1_models.NewServiceInstanceStore(dbConn)
...
func (sic *ServiceInstanceController) ListAll() ([]v1_models.ServiceInstance, error) {
...
func (sic *ServiceInstanceController) CreateNew(newServiceInstance CreateServiceInstanceRequest) (v1_models.ServiceInstance, error) {
	...
	if err != nil {
		return v1_models.ServiceInstance{}, err
	}
...
func (sic *ServiceInstanceController) Reload(serviceInstance v1_models.ServiceInstance, reloadCluster bool, reloadEnvironment bool, reloadService bool) (v1_models.ServiceInstance, error) {
...
func (sic *ServiceInstanceController) GetByEnvironmentAndServiceName(environmentName, serviceName string) (v1_models.ServiceInstance, error) {
	// retrieve the service id if exists
	serviceID, exists := sic.services.DoesServiceExist(serviceName)
	if !exists {
		return v1_models.ServiceInstance{}, v1_models.ErrServiceInstanceNotFound
	}
...
func (sic *ServiceInstanceController) FindOrCreate(environmentName, serviceName string) (int, error) {
	...
	if err != nil {
		if errors.Is(err, v1_models.ErrServiceInstanceNotFound) {
...
// client responses
func (sic *ServiceInstanceController) Serialize(serviceInstances ...v1_models.ServiceInstance) []ServiceInstanceResponse {
	var serviceInstancesList []v1_models.ServiceInstance
