...
func NewDeployController(dbConn *gorm.DB) *DeployController {
	return &DeployController{
		store:            v1_models2.NewDeployStore(dbConn),
...
// version string
func (dc *DeployController) CreateNew(newDeployRequest CreateDeployRequest) (v1_models2.Deploy, error) {
...
func (dc *DeployController) GetDeploysByEnvironmentAndService(environmentName, serviceName string) ([]v1_models2.Deploy, error) {
	...
	if err != nil {
		return []v1_models2.Deploy{}, v1_models2.ErrServiceInstanceNotFound
	}
...
func (dc *DeployController) GetMostRecentDeploy(environmentName, serviceName string) (v1_models2.Deploy, error) {
	serviceInstance, err := dc.serviceInstances.GetByEnvironmentAndServiceName(environmentName, serviceName)
	if err != nil {
		return v1_models2.Deploy{}, v1_models2.ErrServiceInstanceNotFound
	}
...
func (dc *DeployController) ListServiceInstances() ([]v1_models2.ServiceInstance, error) {
...
// client responses
func (dc *DeployController) Serialize(deploy ...v1_models2.Deploy) []DeployResponse {
	var deployList []v1_models2.Deploy
