...
func (m *V2controllersEditablePagerdutyIntegration) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this v2controllers editable pagerduty integration based on context it is used
func (m *V2controllersEditablePagerdutyIntegration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *V2controllersEditablePagerdutyIntegration) UnmarshalBinary(b []byte) error {
	var res V2controllersEditablePagerdutyIntegration
