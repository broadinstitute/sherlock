...
func (m *SherlockAppVersionV3) validateAuthoredByInfo(formats strfmt.Registry) error {
...
func (m *SherlockAppVersionV3) contextValidateAuthoredByInfo(ctx context.Context, formats strfmt.Registry) error {
